...
import { chooseEvent } from '../application/game/chooseEvent'
import { getNextEvent } from '../application/game/getNextEvent'
import { startGame } from '../application/game/startGame'
